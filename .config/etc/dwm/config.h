...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask, XK_equal,   spawn,      SHCMD("pamixer --allow-boost -i $((SOUNDL*3)); kill -44 $(pidof dwmblocks)") },
    ...
    { 0, XF86XK_TouchpadOff,        spawn,      SHCMD("touchpadtoggle 1") },
    { 0, XF86XK_TouchpadOn,         spawn,      SHCMD("touchpadtoggle 0") },
